var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-gx6rb6");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-gx6rb6");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-2nulad");
    			attr(div, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "class", "start svelte-2nulad");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    			...
    			let timer = setInterval(
    				() => {
    					...
    					if (secondLeft == 0) {
    						...
    						$$invalidate(0, secondLeft = totalSecons);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondLeft*/ 1) {
    			$$invalidate(2, progress = (totalSecons - secondLeft) / totalSecons * 100);
    		}
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img src="hand-wash.gif" alt="how to wash hands" bp="offset-5@md 4@md 12@sm" class="svelte-1b8eff0"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
